...
// MARK: - Comuted Priterties
extension Person {
	// nat 를 명확하게 사용하기 위해 프로퍼티를 재 생성
...
extension Person {
	private static func loadBestFriendsFormFile() -> [Person] {
...
extension Person {
	static var bestFriends: [Person] = Person.loadBestFriendsFormFile()
}
